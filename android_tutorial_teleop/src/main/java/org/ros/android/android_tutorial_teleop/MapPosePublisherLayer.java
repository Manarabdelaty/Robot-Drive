    ...
    public boolean onTouchEvent(VisualizationView view, MotionEvent event) {
        ...
        if (visible) {
            ...
            if (event.getAction() == MotionEvent.ACTION_UP) {
                ...
                switch (mode) {
                    case POSE_MODE:
                        Toast.makeText(context, "Pose selected" , Toast.LENGTH_SHORT).show();
                       ...
                       // Toast.makeText(context, "ALL selected" , Toast.LENGTH_SHORT).show(); Toast.makeText(context, "ALL selected" , Toast.LENGTH_SHORT).show(); Toast.makeText(context, "ALL selected" , Toast.LENGTH_SHORT).show();catk////// view.getCamera().setFrame(robotFrame);
